...
select first_name, last_name, "last_connection" from users u where "last_connection" like '221.%';


-- Nombre, apellido y seguidores(followers) de todos a los que lo siguen más de 4600 personas

select first_name, last_name, "followers" from users u where "followers" > 4600;
